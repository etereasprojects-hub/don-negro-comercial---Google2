...
import { ShoppingCart, Package, Star, ArrowLeft, Check, ListChecks, MapPin } from "lucide-react";
...
export default function ProductClient({ product, banners, relatedProducts }: ProductClientProps) {
  ...
  const handleAddToCart = () => {
    addItem({ ...product, precio: prices.precioContado });
