              ...
              <>
                <div className="sticky top-6 space-y-4 w-full flex flex-col items-center">
                  ...
                  >
                    ...
                    {/* Info del Producto */}
                    <div className="p-8 space-y-6 bg-white rounded-t-[3rem] shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
                      <div className="text-center space-y-2">
                        <h2 className="text-2xl font-black text-[#2E3A52] leading-tight uppercase tracking-tighter">
                          {selectedProduct.nombre}
                        </h2>
                        <div className="inline-block bg-slate-100 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-500">
                      ...
                      <div className="space-y-4">
                        {/* Precio Contado */}
                        <div className="bg-gradient-to-r from-[#D91E7A] to-[#6B4199] p-4 rounded-3xl text-white text-center shadow-lg">
                          <p className="text-[10px] font-black uppercase tracking-widest opacity-80 mb-1">Precio Contado</p>
                        ...
                        {prices && (prices.disponible12Meses || prices.disponible6Meses) && (
                          <div className="bg-slate-50 border-2 border-slate-100 p-4 rounded-3xl text-center">
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">¡Llevalo en cuotas!</p>
                            ...
                            <p className="text-[9px] font-bold text-slate-400 uppercase mt-1">Cuotas mensuales fijas</p>
                          </div>
                        )}
                      </div>
